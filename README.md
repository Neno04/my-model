...
| -----                | ----------------       | -----------              | ---------    |
| Data Scientist       | Author                 | [`BrennoCabella`]            | [`cabellab@gmail.com`] |
...
```
git clone https://github.com/<@github_username>/my-model.git
cd my-model
```
...
* [my_model](./my_model/): main Python package with source of the model.
